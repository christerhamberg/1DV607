...
import view.visitor.PrintRulesVisitorSwedish;
...
public class SwedishView implements IView 
    {
        public void DisplayWelcomeMessage()
        {
            ...
            System.out.println("----------------------");
            System.out.println("Skriv 'j' för att Spela, 'n' för nytt kort, 's' för att stanna 'a' för att avsluta\n");
        }
        
        
        public void showTheRules (GameRuleSetInterface ruleset){
      	  System.out.print("\nSpelets regler : ");  
      	  ruleset.showRulesOfTheGame(new PrintRulesVisitorSwedish());
